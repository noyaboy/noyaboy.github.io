/* Background physics, beneath the page (z-index -1, pointer-events none,
   so the content never loses focus). Two behaviors, one layer:
   ...
   - Click sparks: each click inks a tiny collider event at the pointer —
     charged tracks curving out of the vertex with detector hits (a nod to
     the owner's tracking research); bursts self-remove after ~2.5s.
