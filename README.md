...
- `assets/site.css` — the entire design system (light-only, ivory paper)
- `assets/fonts/` — self-hosted variable woff2 subsets of Newsreader & Source Sans 3
- `assets/pets.js` — the resident Bichon & tabby; `assets/tracks.js` — pale specks drift beneath the page, and clicks ink faint collider-event tracks
